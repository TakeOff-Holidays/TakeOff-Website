        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="text-center">
            ...
            <div className="flex space-x-4 justify-center">
              ...
              <a href="https://www.instagram.com/takeoffholidayz/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <div className="space-y-3" style={{fontFamily: "'Afacad', sans-serif"}}>
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-400">dd vyapar bhavan, kp vallon road, kadavanthra, kochi - 682 020</span>
              </div>
              <div className="flex items-center space-x-3">
                <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex flex-col space-y-1">
                  <span className="text-gray-400"><strong>Kochi:</strong> +91 812 902 3279</span>
                  <span className="text-gray-400"><strong>UK:</strong> +44 7785 341907</span>
                  <span className="text-gray-400"><strong>Pathanamthitta:</strong> +91 807 587 7726</span>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-gray-400">support.cok@takeoffholidayz.in</span>
              </div>
            </div>
          </div>
        </div>
