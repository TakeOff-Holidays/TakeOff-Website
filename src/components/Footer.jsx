          ...
          <div>
            ...
            <div className="space-y-3" style={{fontFamily: "'Afacad', sans-serif"}}>
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-400 text-sm md:text-base break-words">dd vyapar bhavan, kp vallon road, kadavanthra, kochi - 682 020</span>
              </div>
              <div className="flex items-start space-x-3">
                <svg className="w-5 h-5 md:w-6 md:h-6 text-gray-400 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
